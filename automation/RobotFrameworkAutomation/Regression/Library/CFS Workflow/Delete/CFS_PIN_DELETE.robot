...
*** Keywords ***
CFS PIN DELETE Design and Assign Validation
    ...
    ${objectId}    Get Service Item Characteristic    ${CFS_PIN}    eaiObjectId
    XML Validate Element by Value    ${request_xml}    //provisioningOrderItem/serviceName/text()    ${objectId}
    # Validate Service Type
    XML Validate Element by Value    ${request_xml}    //provisioningOrderItem/serviceType/text()    ipaccess:Pin
    # Validate Action
