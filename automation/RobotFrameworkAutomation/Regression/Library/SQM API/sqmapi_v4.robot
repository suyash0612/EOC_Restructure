...
*** Variables ***
${API_OPER_CREATEREQUEST}    /eoc/serviceQualificationManagement/v4/serviceQualification
...
Perform Feasibility Check
    ...
    [Documentation]    Invokes SQM API - V4
    ${API_OPER_CREATEREQUEST}  Set Variable    /eoc/serviceQualificationManagement/v5/serviceQualification
    #Prepare SQM Request
    ${request}    sqmapi_V4.Prepare SQM Request    ${fetchConnectionPointInfo}    ${postalCode}    ${houseNumber}    ${houseNumberExtension}    ${serviceSpecificationName}      ${connectionPointIdentifier}
    #Send SQM Request
    log    ${EOC_HOST}
...
Perform ACPE
    ...
    ${ACPE_Request}    sqmapi_V4.Prepare ACPE Request    ${postalCode}    ${houseNumber}    ${houseNumberExtension}     ${TechnologyTypes}
