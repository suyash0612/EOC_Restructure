...
Set the Environment Variable  #Set the Environment Variable
    [Documentation]  Set the Environment Variable
    log to console  ${ENV}
    run keyword if  "${ENV}" == "integration"  get value INT  ${INT}
    run keyword if  "${ENV}" == "acceptance"  get value UAT  ${UAT}

get value INT
    [Arguments]    ${arg1}
    log  The Automation Environment INT
    log  ${arg1['LOGIN_URL']}
    log to console    ${arg1['LOGIN_URL']}
    Set the variables according to the Automation Environment  ${arg1}


get value UAT
    [Arguments]    ${arg1}
    log  The Automation Environment UAT
    log  ${arg1['LOGIN_URL']}
    log to console    ${arg1['LOGIN_URL']}
    Set the variables according to the Automation Environment  ${arg1}
...
Create number range dictionary
    ...
    ${numberDetails}    Post On Session    CHECK_NUMBER    url=/getCustomerNumbers  data=${requestBody}    headers=${header}
...
#        run keyword if  "${testName}" == "${IVR_NAME}"  Click user name and change the fixed number for IVR  ${INDEX}
        ...
        run keyword if  "${compareIVR_NAME}" == "${IVR_NAME}"   Exit For Loop
#        ...  Click Button  xpath://table[@class='table table-striped']/tbody/tr[${INDEX}+1]/td/button
#        log to console  Number:-${test}
    END
...
#        ${userName}  set variable  ${data[1]}
        ...
        run keyword if  "${compare_HG_NAME}" == "${HG_NAME}"  Exit For Loop
#        ...  Click Button  xpath://table[@class='table table-striped']/tbody/tr[${INDEX}+1]/td/button
#        log to console  Number:-${test}
    END
...
#    log to console  ---:${phoneNumber}
    ...
    Check valid extension for update
    #businessHours
    Execute Javascript  document.evaluate('//label[@for="businessHoursMenu-1-active"]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.click();
    Execute Javascript  document.evaluate('//label[@for="businessHoursMenu-2-active"]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.click();
    Execute Javascript  document.evaluate('//label[@for="businessHoursMenu-3-active"]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.click();
    Execute Javascript  document.evaluate('//label[@for="businessHoursMenu-4-active"]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.click();
    Execute Javascript  document.evaluate('//label[@for="businessHoursMenu-*-active"]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.click();
    Execute Javascript  document.evaluate('//label[@for="businessHoursMenu-#-active"]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.click();
    ...
    #afterbusinessHours
    Execute Javascript  document.evaluate('//label[@for="afterHoursMenu-1-active"]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.click();
    Execute Javascript  document.evaluate('//label[@for="afterHoursMenu-2-active"]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.click();
    Execute Javascript  document.evaluate('//label[@for="afterHoursMenu-3-active"]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.click();
    Execute Javascript  document.evaluate('//label[@for="afterHoursMenu-4-active"]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.click();
    Execute Javascript  document.evaluate('//label[@for="afterHoursMenu-*-active"]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.click();
    Execute Javascript  document.evaluate('//label[@for="afterHoursMenu-#-active"]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.click();
    ...
    Scroll Element Into View  //button[@data-testid='submitButton']
    Sleep  2
    Click Button  //button[@data-testid='submitButton']
    # Click Button  xpath://div[@class='MuiGrid-root MuiGrid-item']/button
    Create File  GroupDetails/IVR/IVR_name.txt  ${IVR_NAME}
...
#    log to console  ---:${phoneNumber}
    ...
    FOR  ${INDEX}  IN RANGE  1  ${count+1}
        ...
        # Execute Javascript  document.evaluate('//div[@aria-label='Forwarding Options']/div[${INDEX}]//span', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.click();
        Scroll Element Into View  //div[@aria-label='Forwarding Options']/div[${INDEX}]//span
        Sleep  3
        Click Element  //div[@aria-label='Forwarding Options']/div[${INDEX}]//span
    END
...
#    log to console  List: ${addedUserNameList} ${addedUserNumberList}
    Scroll Element Into View  xpath://span[text()='Mathéo Agnès 1811114401']/preceding-sibling::button
    Click Element  xpath://span[text()='Mathéo Agnès 1811114401']/preceding-sibling::button
    # Click Element  xpath://button[@class='member-select__button member-select__button--add']
    # Click Element  xpath://div[@class='MuiGrid-root MuiGrid-item']/button
    Scroll Element Into View  //div[@class='MuiGrid-root MuiGrid-item']/button
    Unselect Frame
    Click Button  //div[@class='MuiGrid-root MuiGrid-item']/button
...
#        should be equal  ${Telephone_Number}  ${testNumber}
        run keyword if  "${Telephone_Number}" == "${testNumber}"  Delete the number  ${INDEX}
        run keyword if  "${Telephone_Number}" == "${testNumber}"  Exit For Loop
#        ...  Click Button  xpath://table[@class='table table-striped']/tbody/tr[${INDEX}+1]/td/button
#        log to console  Number:-${test}
    END
#    ${test}  Get Text  xpath://table[@class='table table-striped']/tbody/tr/td[2]
...
Check license
    ...
    log to console  ${c}
    run keyword if  "${c}" == "1"  Display Warning    ${PBX_Device}
...
Validate Broadsoft details for ADD-Contact
    ...
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/PhoneBookEntries?ned=broadsoft&nei=HV01&request_id=${request_id}&group_id=${Group_ID}  headers=${header}
...
Validating supervised agents on broadsoft
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/CallCenter?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${UC75Data['CC_ObjectId']}  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
...
#    sleep  10
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/CallCenterQueueAnnouncements?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${UC76Data['CC_ObjectId']}  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
...
#    sleep  10
    ...
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/CallCenterNightService?ned=broadsoft&nei=HV01&request_id=${request_id}&call_center_id=${UC77DataVID}  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
...
#    sleep  10
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION_CC}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/CallCenterHolidayService?ned=broadsoft&nei=HV01&request_id=${request_id}&call_center_id=${UC77DataVID}  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
...
#    sleep  10
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION_CC}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/CallCenterOverflow?ned=broadsoft&nei=HV01&request_id=${request_id}&call_center_id=${UC77DataVID}  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
...
#    ${regionCode}  Load JSON From File  createOrderJson/regionCode.json
    ${regionCode}  set variable  {"regionCode": ["020","070","010","079"]}
    ${regionCode}  evaluate    json.loads(r'''${regionCode}''')    json
    ${count}  get length  ${regionCode['regionCode']}
    Set global Variable  ${size}  100
    log  ${count}
    FOR    ${INDEX}    IN RANGE    0    ${count}
        log  ${regionCode['regionCode'][${INDEX}]}
        ${requestBody}  Load JSON From File  ${WORKSPACE}/TestData/HV/createOrderJson/availability.json
        ${requestBody}  Update Value In Json  ${requestBody}  $..availabilityCheckRequest.relatedParty.party[0].partyId  ${cutomerId}
        ${requestBody}  Update Value In Json  ${requestBody}  $..availabilityCheckRequest.channelRef._id  ${orderId}
        ${requestBody}  Update Value In Json  ${requestBody}  $..availabilityCheckRequest.resourceCapacityDemand.place._id  ${regionCode['regionCode'][${INDEX}]}
        ${requestBody}  Update Value In Json  ${requestBody}  $..availabilityCheckRequest.resourceCapacityDemand.resourceCapacityDemandAmount  ${size}
        ...
        ${numberRangeDetails}    Post On Session    CHECK_AVAILABILITY    url=/availabilityCheck  data=${requestBody}    headers=${header}
        ...
        exit for loop if  ${numberRangeError} == @{EMPTY}
    END
...
Reservation of number range
    ${requestBody}  Load JSON From File  ${WORKSPACE}/TestData/HV/createOrderJson/reservation.json
    ${requestBody}  Update Value In Json  ${requestBody}  $..acceptNumberResvRequest.relatedParty.party[0].partyId  ${cutomerId}
    ${requestBody}  Update Value In Json  ${requestBody}  $..acceptNumberResvRequest.channelRef._id  ${orderId}
    ${requestBody}  Update Value In Json  ${requestBody}  $..acceptNumberResvRequest.resourceReservationItem.resourcePool.resources[0].value  ${numberRange}
    ${requestBody}  Evaluate    json.dumps(${requestBody})    json
    set global variable  ${requestBody}
    log  ${requestBody}
    create session  CHECK_RESERVATION  ${reservationPoolURL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${authEAIReservationPool}
    ${reservationListDetails}    Post On Session    CHECK_RESERVATION    url=/reservation  data=${requestBody}    headers=${header}
...
Place the Order for HV Group
    ...
    log to console  ${startNumber}
    ${requestBody}  Load JSON From File  ${WORKSPACE}/TestData/HV/createOrderJson/createOrder.json
    ${requestBody}  Update Value In Json  ${requestBody}  $..requestId  REQEOC${requestId}
    ${requestBody}  Update Value In Json  ${requestBody}  $..externalId  BSSORDERID${requestId}
    ${requestBody}  Update Value In Json  ${requestBody}  $..relatedParty[0].id  ${cutomerId}
    ${requestBody}  Update Value In Json  ${requestBody}  $..relatedParty[0].name  ${cutomerId}
#    ${requestBody}  Update Value In Json  ${requestBody}  $..relatedParty[0].name  Robert van der woud
    ${requestBody}  Update Value In Json  ${requestBody}  $..orderItem[0].service.serviceCharacteristic[0].value  ${groupName}
    ${requestBody}  Update Value In Json  ${requestBody}  $..orderItem[0].service.serviceCharacteristic[2].value  ${BSCSID}
    ${requestBody}  Update Value In Json  ${requestBody}  $..orderItem[2].service.serviceCharacteristic[1].value  ${startNumber}
    ${requestBody}  Update Value In Json  ${requestBody}  $..orderItem[2].service.serviceCharacteristic[3].value  ${rlId}
    ${requestBody}  Update Value In Json  ${requestBody}  $..orderItem[2].service.serviceCharacteristic[2].value  ${size}
    ${requestBody}  Evaluate    json.dumps(${requestBody})    json
    set global variable  ${requestBody}
    log  ${requestBody}
...
#    ${requestBody}    Catenate    ${requestBody}
    ${numberDetails}    Post On Session    CREATE_ORDER    url=/serviceOrder  data=${requestBody}    headers=${header}
...
Retrive order item details for group
    ...
    ${header}    Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
    ${eocOrder}  Get On Session  GET_ORDER  url=/${ORDER_ID}?expand=orderItems  headers=${header}
...
Set group id(CFS_VOICE_GROUP)
    ...
    ${header}    Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
    ${service}  Get On Session  CHECK_SR  url=/${SR_ID[0]}?expand=true  headers=${header}
...
Get the details from SR API
    ...
    create session  CHECK_SR  ${SR_URL}
    ${header}    Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
    ${service}  Get On Session  CHECK_SR  url=/${groupSRID}?expand=true  headers=${header}
...
Validate Broadsoft details for ADD-Business hours schedules
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/Schedule?ned=broadsoft&nei=HV01&request_id=${request_id}&group_id=${Group_ID}&type=Time&name=${businessHourEventName}  headers=${header}
#    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
...
Validate Broadsoft details for Update-Business hours schedules
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/Schedule?ned=broadsoft&nei=HV01&request_id=${request_id}&group_id=${Group_ID}&type=Time&name=${scheduleName}  headers=${header}
#    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
...
Validate Broadsoft details for Delete-Business hours schedules
    ...
    ${request_id}  Evaluate  int(round(time.time() * 1000))  time
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}expe
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/Schedule?ned=broadsoft&nei=HV01&request_id=${request_id}&group_id=${Group_ID}&type=Time&name=${scheduleName}  headers=${header}  expected_status=404
#    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
...
Validate Broadsoft details for ADD-Closing hours schedules
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/Schedule?ned=broadsoft&nei=HV01&request_id=${request_id}&group_id=${Group_ID}&type=Holiday&name=${closingHourEventName}  headers=${header}
#    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
...
Group announcement validation for BroadSoft
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/MusicOnHold?ned=broadsoft&nei=HV01&request_id=${request_id}&group_id=${Group_ID}  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
...
Get bearer token for tyk API
    ...
    ${base64Username}  Decode Base64  ${base64UsernameConverted}
    ${base64Password}  Decode Base64  ${base64PasswordConverted}
    ...
    ${bearerDetails}    Post On Session    CREATE_BEARER_TOKEN    url=/token  data=${requestBody}    headers=${header}
...
Get Mobile Number
    ...
    ${mobileNumberDetails}  Get On Session  CHECK_MOBILE_NUMBER  url=/${GROUP_SR_ID}/available_mobile_numbers  headers=${header}
...
Get start number from SRId and set portOutSize
    create session  CHECK_SR  ${SR_URL}
    ${header}    Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
    ${service}  Get On Session  CHECK_SR  url=/${numberRangeSRId}?expand=true  headers=${header}
    ${service}  set variable  ${service.json()}
...
#    ${endDate}  set variable  2020-07-09T23:59:59.000Z
    ...
    ${orderDetails}  Get On Session  GET_ORDER_ID  url=/?relatedParties.role=Customer&relatedParties.reference=${CUSTOMER_ID}&createdDate.gte=${startDate}&createdDate.lte=${endDate}&sort=createdDate&state.in=OPEN.PROCESSING.RUNNING
...
Check the whole order according to date
    ...
    sleep  3
    create session  GET_ORDER_ID  ${CHECK_ORDER_URL}
    ${orderDetails}  Get On Session  GET_ORDER_ID  url=/?relatedParties.role=Customer&relatedParties.reference=${CUSTOMER_ID}&createdDate.gte=${startDate}&createdDate.lte=${endDate}&sort=createdDate
#    log to console  value:-${orderDetails.content}
    ${orderDetailsLen}  get length  ${orderDetails.json()}
...
Get group id(CFS_VOICE_GROUP)
    create session  CHECK_SR  ${SR_URL}
    ${header}    Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
    ${service}  Get On Session  CHECK_SR  url=/${GROUP_SR_ID}?expand=true  headers=${header}
#    ${service}  set variable  ${service.json()}
    ${Group_ID}  get value from json  ${service.json()}  $.serviceCharacteristics[?(@.name=="eaiObjectId")].value
    ${Group_ID}  set variable  ${Group_ID[0]}
    set global variable  ${Group_ID}
...
#    ${selectedNumber}  set variable  31209023405
    ...
    ${header}   Create Dictionary    Content-Type=application/json    authorization=${EAI_AUTHORIZATION}
#    ${requestBody}    Catenate    {"type": "nmext-adv/extendednmservice/getcustomernumbers","request": {"type": "nmext/getcustomernumbersrequest","customerId":"${CUSTOMER_ID}","status":"ASSIGNED"}}
    ${numberDetails}    Get On Session    CHECK_NUMBER    url=?name=${selectedNumber}&Type=TN&subType=FIXED&svcCategory=GEN  headers=${header}
#    log to console  ${numberDetails.content}
...
#    set global variable  ${oldNumber}
    ...
    ${header}   Create Dictionary    Content-Type=application/json    authorization=${EAI_AUTHORIZATION}
#    ${requestBody}    Catenate    {"type": "nmext-adv/extendednmservice/getcustomernumbers","request": {"type": "nmext/getcustomernumbersrequest","customerId":"${CUSTOMER_ID}","status":"ASSIGNED"}}
    ${numberDetails}    Get On Session    CHECK_NUMBER    url=?name=${oldNumber}&Type=TN&subType=FIXED&svcCategory=GEN  headers=${header}
#    log to console  ${numberDetails.content}
    ${numberDetails}  set variable  ${numberDetails.json()}
    log to console  ${numberDetails[0]['derivedStatus']}
    ...
    ${header}   Create Dictionary    Content-Type=application/json    authorization=${EAI_AUTHORIZATION}
#    ${requestBody}    Catenate    {"type": "nmext-adv/extendednmservice/getcustomernumbers","request": {"type": "nmext/getcustomernumbersrequest","customerId":"${CUSTOMER_ID}","status":"ASSIGNED"}}
    ${numberDetails}    Get On Session    CHECK_NUMBER    url=?name=${testNo1}&Type=TN&subType=FIXED&svcCategory=GEN  headers=${header}
#    log to console  ${numberDetails.content}
    ${numberDetails}  set variable  ${numberDetails.json()}
    log to console  ${numberDetails[0]['derivedStatus']}
    should be equal  ${numberDetails[0]['derivedStatus']}  Assigned
...
Get object value for the CFS_VOICE_PRF_BASIC
    create session  CHECK_SR  ${SR_URL}
    ${header}    Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
    ${service}  Get On Session  CHECK_SR  url=/${SR_ID_CFS_VOICE_USER[0]}?expand=true  headers=${header}
    ${service}  set variable  ${service.json()}
...
check if object is present in EAI for User with Basic FO profile
    ...
    ${header}    Create Dictionary    Content-Type=application/json    authorization=${EAI_AUTHORIZATION}
    ${eaiRes}  Get On Session  CHECK_EAI  url=/vuser?serviceInstanceId=${SR_ID[0]}  headers=${header}
...
check if object is present in broadSoft for User with Basic FO profile
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/User?ned=broadsoft&nei=HV01&request_id=${request_id}&id=${objectValue}@hv.tele2.nl  headers=${header}
...
Validate BroadSoft for out going number
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/ConfigurableClid?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
...
check feature BasicCallLogs
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/BasicCallLogs?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
...
check feature CallForwardingAlways
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/CallForwardingAlways?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
check feature CallForwardingBusy
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/CallForwardingBusy?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
check feature CallForwardingNoAnswer
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/CallForwardingNoAnswer?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
check feature CallHold
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/CallHold?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
check feature CallTransfer
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/CallTransfer?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
check feature CallWaiting
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/CallWaiting?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
check feature CallingLineIdentificationPresentation
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/CallingLineIdentificationPresentation?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
check feature CallingLineIdentificationRestriction
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/CallingLineIdentificationRestriction?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
check feature ConnectedLineIdentificationPresentation
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/ConnectedLineIdentificationPresentation?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
check feature ConnectedLineIdentificationRestriction
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/ConnectedLineIdentificationRestriction?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
check feature CallingNameDelivery
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/CallingNameDelivery?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
check feature DoNotDisturb
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/DoNotDisturb?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
check feature MultipleCallArrangement
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/MultipleCallArrangement?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
check feature NWayCall
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/NWayCall?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
check feature SipAccount
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/SipAccount?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
check feature ThirdpartyUserVoicemail
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/ThirdpartyUserVoicemail?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
...
Validating CFS_FMC on broadsoft
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/FMC?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl&mobile_phone_number=${mobileNumber}  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
...
#    ${objectValue}  Get file  GroupDetails/u-IdMO.txt
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/FMC?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl&mobile_phone_number=${mobileNumber}  headers=${header}  expected_status=404
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
...
Validating CallCenterAgent on broadsoft
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/CallCenterAgent?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
...
Validating CallCenterSupervisor on broadsoft
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/CallCenterSupervisor?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  ${broadSoftRes['meta']['message']}  The request was successful.
    log to console   ${broadSoftRes['meta']['message']}
...
check if voicemail exists in Acision for User with Basic FO profile
    ...
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${acisionRes}  Get On Session  CHECK_ACISION  url=/User?ned=acision&nei=10.1.137.30&request_id=${request_id}&service_provider=tele2.nl&telephone_number=${phoneNumber}&user_id=${objectValue}  headers=${header}
...
check if voicemail exists in Acision for User with Mobile Number
    ...
    create session  CHECK_ACISION  ${ACISION_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${acisionRes}  Get On Session  CHECK_ACISION  url=/User?ned=acision&nei=10.1.137.30&request_id=${request_id}&service_provider=tele2.nl&telephone_number=${mobileNumber}&user_id=${objectValue}  headers=${header}
    should be equal  ${acisionRes.json()['meta']['message']}  The request was successful.
    log to console  done validation in Acision API for User with Basic FO profile
    log  done validation in Acision API for User with Basic FO profile
...
check if object is present in EAI for IVR
    ...
    create session  CHECK_EAI  ${EAI_URL}
    ${header}    Create Dictionary    Content-Type=application/json    authorization=${EAI_AUTHORIZATION}
    ${eaiRes}  Get On Session  CHECK_EAI  url=/vvirtualuser?serviceInstanceId=${SR_ID[0]}  headers=${header}
    should be equal  ${eaiRes.json()[0]['name']}  ${objectValue}
    ${extension}  get value from json  ${service}  $.serviceCharacteristics[?(@.name=='extension')]
    ${associatednumber}  get value from json  ${service}  $.serviceCharacteristics[?(@.name=='directoryNumber')]
    should be equal  ${extension[0]['value']}  ${eaiRes.json()[0]['extension']}
...
#    log to console  ${objectValue}
    ...
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT_IVR  url=/InteractiveVoiceResponse?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
...
check if object is present in broadSoft for Hunt Group
    ...
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT_HUNT_GROUP  url=/HuntGroup?id=${objectValue}@hv.tele2.nl&ned=broadsoft&nei=HV01&request_id=${request_id}  headers=${header}
    ${phoneNumber}  get value from json  ${service}  $.serviceCharacteristics[?(@.name=='directoryNumber')]
    should be equal  ${phoneNumber[0]['value']}  ${broadSoftRes.json()['body']['phone_number']}
    set global variable  ${phoneNumber}
...
Check the details of the added user in BroadSoft
    ...
    FOR  ${INDEX}  IN RANGE  0  ${count}
        ...
        create session  CHECK_BROADSOFT_HUNT_GROUP  ${BROADSOFT_URL}
        ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
        ${broadSoftRes}  Get On Session  CHECK_BROADSOFT_HUNT_GROUP  url=/User?id=${userObjectIDList[${INDEX}]}&ned=broadsoft&nei=HV01&request_id=${request_id}  headers=${header}
...
check if object is present in EAI for CFS_VOICE_DECT_HOST
    ...
    create session  CHECK_EAI  ${EAI_URL}
    ${header}    Create Dictionary    Content-Type=application/json    authorization=${EAI_AUTHORIZATION}
    ${eaiRes}  Get On Session  CHECK_EAI  url=/vdevice?serviceInstanceId=${SR_ID[0]}  headers=${header}
...
check if object is present in broadSoft for CFS_VOICE_DECT_HOST
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/Device?ned=broadsoft&nei=HV01&request_id=${request_id}&id=${objectValue}&group_id=${groupID}  headers=${header}
    log to console  ${broadSoftRes.content}
#    log to console  ${broadSoftRes.content}
...
check if object is present in broadSoft for CFS_VOICE_FAX2EMAIL
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/FaxToEmail?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    log to console  ${broadSoftRes.content}
    ${eaiObjectId}  get value from json  ${service}  $.serviceCharacteristics[?(@.name=='eaiObjectId')]
    ${eaiObjectId}  set variable  ${eaiObjectId[0]['value']}
...
check if object is present in broadSoft for CFS_VOICE_FAX2EMAIL delete functionality
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/FaxToEmail?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}  expected_status=404
    log to console  ${broadSoftRes.content}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  "${broadSoftRes['meta']['message']}"  "The requested network element could not be found."
    log  ${broadSoftRes['meta']['message']}
...
check if object is present in broadSoft for CFS_VOICE_CALL_CENTER
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/CallCenter?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    log to console  ${broadSoftRes.content}
    ${eaiObjectId}  get value from json  ${service}  $.serviceCharacteristics[?(@.name=='eaiObjectId')]
    ${eaiObjectId}  set variable  ${eaiObjectId[0]['value']}
    should be equal  ${selectedNumber}  ${broadSoftRes.json()['body']['phone_number']}
...
#    [Arguments]  ${service}  ${objectValue}
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/CallCenter?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}  expected_status=404
    log to console  ${broadSoftRes.content}
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  "${broadSoftRes['meta']['message']}"  "The requested network element could not be found."
    log  ${broadSoftRes['meta']['message']}
...
check if object is present in EAI for CFS_VOICE_FLEX_HOST
   [Arguments]  ${objectValue}  ${service}
    ...
    create session  CHECK_EAI  ${EAI_URL}
    ${header}    Create Dictionary    Content-Type=application/json    authorization=${EAI_AUTHORIZATION}
    ${eaiRes}  Get On Session  CHECK_EAI  url=/vvirtualuser?serviceInstanceId=${SR_ID[0]}&fs.vLineport&fs.vLineport.vDevice  headers=${header}
#    log to console  ${eaiRes.content}
...
check if object is present in broadSoft for CFS_VOICE_FLEX_HOST
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/FlexHost?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
#    log to console  ${broadSoftRes.content}
...
check if device linked with user
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/Device?ned=broadsoft&nei=HV01&request_id=${request_id}&id=${deviceID}&group_id=${groupID}  headers=${header}
#    log to console  ${broadSoftRes.content}
...
check if object is present in broadSoft for CFS_VOICE_PRF_FLEX_GUEST
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/FlexGuest?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}
    log to console  ${broadSoftRes.content}
...
check if item is present in SR for delete
    ...
    create session  CHECK_SR  ${SR_URL}
    ${header}    Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
    ${service}  Get On Session  CHECK_SR  url=/${SR_ID[0]}?expand=true  headers=${header}  expected_status=404
...
#    log to console  ${objectValue}
    create session  CHECK_BROADSOFT_IVR  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT_IVR  url=/User?ned=broadsoft&nei=HV01&request_id=${request_id}&id=${userObjectValue}@hv.tele2.nl  headers=${header}  expected_status=404
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  "${broadSoftRes['meta']['message']}"  "The requested network element could not be found."
    log  ${broadSoftRes['meta']['message']}
...
#    log to console  ${objectValue}
    create session  CHECK_BROADSOFT_IVR  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT_IVR  url=/UCOne?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${userObjectValue}@hv.tele2.nl  headers=${header}  expected_status=404
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  "${broadSoftRes['meta']['message']}"  "The requested network element could not be found."
    log  ${broadSoftRes['meta']['message']}
...
#    log to console  ${objectValue}
    create session  CHECK_BROADSOFT_IVR  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT_IVR  url=/InteractiveVoiceResponse?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}  expected_status=404
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  "${broadSoftRes['meta']['message']}"  "The requested network element could not be found."
    log  ${broadSoftRes['meta']['message']}
...
#    log to console  ${objectValue}
    create session  CHECK_BROADSOFT_IVR  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT_IVR  url=/HuntGroup?ned=broadsoft&nei=HV01&request_id=${request_id}&id=${objectValue}@hv.tele2.nl  headers=${header}  expected_status=404
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  "${broadSoftRes['meta']['message']}"  "The requested network element could not be found."
    log  ${broadSoftRes['meta']['message']}
...
#    log to console  ${objectValue}
    create session  CHECK_BROADSOFT_IVR  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT_IVR  url=/FlexHost?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}  expected_status=404
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  "${broadSoftRes['meta']['message']}"  "The requested network element could not be found."
    log  ${broadSoftRes['meta']['message']}
...
#    log to console  ${objectValue}
    create session  CHECK_BROADSOFT_IVR  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT_IVR  url=/FlexGuest?ned=broadsoft&nei=HV01&request_id=${request_id}&user_id=${objectValue}@hv.tele2.nl  headers=${header}  expected_status=404
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  "${broadSoftRes['meta']['message']}"  "The requested network element could not be found."
    log  ${broadSoftRes['meta']['message']}
...
check if object is present in acision for delete functionality for user
    ...
    create session  CHECK_ACISION  ${ACISION_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${acisionRes}  Get On Session  CHECK_ACISION  url=/User?ned=acision&nei=10.1.137.30&request_id=${request_id}&service_provider=tele2.nl&telephone_number=${phoneNumber}&user_id=${userObjectValue}  headers=${header}
...
Check which workflow steps are in error
    ...
    ${flowResult}  Get On Session  CHECK_WORKFLOW  url=/?orderId=${ORDER_ID}&expand=tasks&wf
...
Get Error log and Status
    ...
    ${header}  Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
    ${senderRes}  Get On Session  GET_MESSAGE_LOG  url=/messageLog?processid=${processId[0]}  headers=${header}
...
#    log to console  ${senderRes.json()[2]['id']}
    ...
    ${header}  Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
    ${errorRes}  Get On Session  GET_ERROR_STATUS  url=/messageLog/${logId}/payload?mode=I  headers=${header}
...
check if object is present in broadSoft for dedicated device
    ...
    create session  CHECK_BROADSOFT  ${BROADSOFT_URL}
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT  url=/Device?ned=broadsoft&nei=HV01&request_id=${request_id}&id=${objectValue}&group_id=${Group_ID}  headers=${header}
...
check SR details of user for linked device
    ...
    create session  CHECK_SR  ${SR_URL}
    ${header}    Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
    ${service}  Get On Session  CHECK_SR  url=/${userSRID}?expand=true  headers=${header}
...
Validate EOC-SR Service Inventory for UC34 for linked user
    create session  CHECK_SR  ${SR_URL}
    ${header}    Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
    ${service}  Get On Session  CHECK_SR  url=/${mudSRID}?expand=true  headers=${header}
    ${serviceRelationships}  set variable  ${service.json()['serviceRelationships']}
    ${size}  get length  ${serviceRelationships}
    FOR  ${INDEX}  IN RANGE  0  ${size}
...
#    log to console  ${objectValue}
    ...
    ${header}  create dictionary  Content-Type=application/json    authorization=${BA_AUTHORIZATION}
    ${broadSoftRes}  Get On Session  CHECK_BROADSOFT_DECT  url=/Device?ned=broadsoft&nei=HV01&request_id=${request_id}&id=${objectValue}&group_id=${groupID}  headers=${header}  expected_status=404
    ${broadSoftRes}  set variable  ${broadSoftRes.json()}
    should be equal  "${broadSoftRes['meta']['message']}"  "The requested network element could not be found."
    log  ${broadSoftRes['meta']['message']}
...
Get the details of last port-in
    ...
    ${header}    Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
#    &{params}    Create Dictionary    expand=orderItems    Content-Type=application/json    authorization=Basic ${EOC_API_AUTH}
    ${eocOrder}  Get On Session  GET_ORDER  url=/${orderIdForPortIn}?expand=orderItems  headers=${header}
...
Check EAI action for the portOut numbers
    ...
    ${header}   Create Dictionary    Content-Type=application/json    authorization=${EAI_AUTHORIZATION}
    ${numberDetails}    Post On Session    CHECK_PORT_OUT_STATUS    url=/nmext-adv/ExtendedNMService/validatePortOut  data=${requestBody}    headers=${header}
    log to console  ${numberDetails.content}
...
Create Order for Port-Out
    ...
    ${header}   Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
    ${numberDetails}    Post On Session    CREATE_ORDER    url=/serviceOrderingManagement/v1/serviceOrder  data=${requestBody}    headers=${header}
    log to console  ${numberDetails.content}
    ${ORDER_ID}  set variable  ${numberDetails.json()['id']}
    set global variable  ${ORDER_ID}
...
Validate the number status in EAI
    ...
    FOR    ${INDEX}    IN RANGE    0    ${portOutSize}
        create session  CHECK_NUMBER  ${numberCheckEAI}
        ${header}   Create Dictionary    Content-Type=application/json    authorization=${EAI_AUTHORIZATION}
        ${numberDetails}    Get On Session    CHECK_NUMBER    url=?name=${startNumber}&Type=TN&subType=FIXED&svcCategory=GEN  headers=${header}
...
Create Request Body for Port-In
    ...
    FOR    ${INDEX}    IN RANGE    0    ${portInSize}
        ...
        ${header}   Create Dictionary    Content-Type=application/json    authorization=${EAI_AUTHORIZATION}
        ${numberDetails}    Get On Session    CHECK_NUMBER    url=?name=${phoneNumber}&Type=TN&subType=FIXED&svcCategory=GEN  headers=${header}
        log to console  ${numberDetails.content}
...
Get workflow task and check the task status
    ...
    ${header}    Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
#    &{params}    Create Dictionary    expand=orderItems    Content-Type=application/json    authorization=Basic ${EOC_API_AUTH}
    ${orderTaskWorkflow}  Get On Session  GET_ORDER_TASK  url=/?orderId=${ORDER_ID}&expand=tasks&wf&taskFilter=privilege  headers=${header}
...
Validate Port-In Number Range and Status in EAI
    ...
    ${header}    Create Dictionary    Content-Type=application/json    authorization=${EAI_AUTHORIZATION}
    ${numberStatusCheckRes}  Get On Session  numberStatusCheck  url=?name=${reservationListId}&fs=attrs,dynAttrs&fs.numbers=attrs,dynAttrs  headers=${header}
...
Trigger Action confirm port-In on manual task
    ...
    ${header}   Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
    ${confirmDetails}    Post On Session    CONFIRM_TASK    url=/serviceOrderingManagement/v1/serviceOrder/${ORDER_ID}/service/${portInSRId}/executeTaskAction  data=${requestBody}    headers=${header}
...
Validate - Set Number Routing to Voice Platform LRN on ENUM
    ...
    ${portInOrdersRes}  Get On Session  portInOrder  url=/?countryCode=NL&msisdnStart=${startNumber}  headers=${header}
...
Get data for port-in
    ...
    create session  CHECK_SR  ${SR_URL}
    ${header}    Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
    ${service}  Get On Session  CHECK_SR  url=/${SR_ID}?expand=true  headers=${header}
...
Validate Outgoing payload towards PRoPR
    ...
    ${header}   Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
    ${GetMessageIDDetails}    Get On Session    GetMessageID    url=/logManagement/v1/messageLog?orderid=${ORDER_ID}    headers=${header}
...
#    ${count}  get length  ${GetMessageIDDetails}
    ...
    ${GetMessageDetails}    Get On Session    GetMessageID    url=/logManagement/v1/messageLog/${messageIDDetails[0]['id']}/payload?mode=O    headers=${header}
...
#        Append To File  numberRangeBackUp/numberRangeCreate.csv  111\n
        ${numberDetails}    Post On Session    CREATE_ORDER    url=/ResourcePoolManagement/availabilityCheck  data=${requestBody}    headers=${header}
...
Get the number range from csv file
    ...
    FOR  ${line}  IN  @{lines}
        ...
        ${requestBody}  Evaluate    json.dumps(${requestBody})    json
        log  ${requestBody}
        ${reservationListIdData}    Post On Session    CREATE_ORDER    url=/ResourcePoolManagement/reservation  data=${requestBody}    headers=${header}
...
Check If the group contains held orders or not
    ...
    create session  GET_ORDER  ${BASE_URL}
    ${header}    Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
    ${eocGroupOrderDetails}  Get On Session  GET_ORDER  url=/?relatedParties.role=Customer&relatedParties.reference=${CUSTOMER_ID}&createdDate.gte=${startDate}&createdDate.lte=${endDate}&sort=-createdDate&state.in=OPEN.PROCESSING.RUNNING,OPEN.SCHEDULED,OPEN.NOT_STARTED,OPEN.DRAFT,CLOSED.ABORTED.ABORTED_BYSERVER,OPEN.SUSPENDED,OPEN.SUSPENDED.BYCLIENT,ERROR,OPEN.RUNNING.AWAITING_INPUT  headers=${header}
...
Create and place the order for DELETE-HV Group
    ...
    ${header}   Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
#    ${requestBody}    Catenate    ${requestBody}
    ${numberDetails}    Post On Session    DELETE_ORDER    url=/serviceOrderingManagement/v1/serviceOrder  data=${requestBody}    headers=${header}
    log to console  ${numberDetails.content}
...
Get related Orders
    ...
    create session  GET_ORDER  ${BASE_URL}
    ${header}    Create Dictionary    Content-Type=application/json    authorization=${AUTHORIZATION}
    ${eocOrderDetails}  Get On Session  GET_ORDER  url=/${ORDER_ID}/?expand=false
